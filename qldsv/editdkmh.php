...
$id_sv = $_GET['idSV'];
$id_mh = $_GET['idMH'];
$kq = $qt->Diem_ChiTiet($id_sv, $id_mh);
if($kq) $row = $kq->fetch_assoc();

if(isset($_POST['submit'])) {
    $idSV = $_POST['idSV'];
    $idMH = $_POST['idMH'];
    $qt ->Diem_Sua($idSV, $id_sv, $idMH, $id_mh);
                                ...
                                <div class="form-group" >
                                    ...
                                    <select required name="idSV" class="form-control">
                                        <?php while ($sv = $showSV->fetch_assoc()) { ?>
                                            <?php if ($sv['MaSV'] == $row['SV']) { ?>
                                                <option value="<?=$sv['MaSV'] ?>" selected><?=$sv['MaSV'] ?> - <?=$sv['HotenSV'] ?></option>
                                            <?php } else { ?>
